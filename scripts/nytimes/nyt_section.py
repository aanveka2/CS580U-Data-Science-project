# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 03:36:27 2019
...
url ='https://api.nytimes.com/svc/topstories/v2/home.json?api-key=t5iAd3WTx5bAdx1X2Pr987wYOHbEKHRJ'
#https://api.nytimes.com/svc/archive/v1/2019/7.json?api-key=t5iAd3WTx5bAdx1X2Pr987wYOHbEKHRJ
r= requests.get(url)
json_data=r.json()

databaseName = "Trenddit"
collectionName = "NYTimes_section"
